rule AssemblyConfig:
	...
	shell:
		"""
		mkdir -p {config[Assembly][organelle_database_folder]}
		get_organelle_config.py -a {config[Assembly][OrganelleDatabasesDownload]} --config-dir {config[Assembly][organelle_database_folder]}
		"""
